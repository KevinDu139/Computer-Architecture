...
add wave -noupdate -expand -group aluif /system_tb/DUT/CPU/DP/aluif/outputPort
...
add wave -noupdate -group ifid /system_tb/DUT/CPU/DP/ifid/pcin
add wave -noupdate -group ifid /system_tb/DUT/CPU/DP/ifid/pcout
...
add wave -noupdate -expand -group memwb /system_tb/DUT/CPU/DP/memwb/instructionin
add wave -noupdate -expand -group memwb /system_tb/DUT/CPU/DP/memwb/instructionout
add wave -noupdate -expand -group memwb /system_tb/DUT/CPU/DP/memwb/dmemload_out
add wave -noupdate -expand -group memwb /system_tb/DUT/CPU/DP/memwb/dmemload_in
add wave -noupdate -expand -group memwb /system_tb/DUT/CPU/DP/memwb/ihit
add wave -noupdate -expand -group memwb /system_tb/DUT/CPU/DP/memwb/npcin
add wave -noupdate -expand -group memwb /system_tb/DUT/CPU/DP/memwb/RegWEN_in
add wave -noupdate -expand -group memwb /system_tb/DUT/CPU/DP/memwb/MemtoReg_in
add wave -noupdate -expand -group memwb /system_tb/DUT/CPU/DP/memwb/Regdst_in
add wave -noupdate -expand -group memwb /system_tb/DUT/CPU/DP/memwb/jsel_in
add wave -noupdate -expand -group memwb /system_tb/DUT/CPU/DP/memwb/aluop_in
add wave -noupdate -expand -group memwb /system_tb/DUT/CPU/DP/memwb/npcout
add wave -noupdate -expand -group memwb /system_tb/DUT/CPU/DP/memwb/RegWEN_out
add wave -noupdate -expand -group memwb /system_tb/DUT/CPU/DP/memwb/MemtoReg_out
add wave -noupdate -expand -group memwb /system_tb/DUT/CPU/DP/memwb/Regdst_out
add wave -noupdate -expand -group memwb /system_tb/DUT/CPU/DP/memwb/jsel_out
add wave -noupdate -expand -group memwb /system_tb/DUT/CPU/DP/memwb/outputPort_in
add wave -noupdate -expand -group memwb /system_tb/DUT/CPU/DP/memwb/outputPort_out
...
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/exmem/instructionin
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/exmem/instructionout
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/exmem/ihit
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/exmem/dhit
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/exmem/rdat1_in
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/exmem/rdat2_in
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/exmem/npcin
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/exmem/newpcin
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/exmem/dWEN_in
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/exmem/dREN_in
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/exmem/RegWEN_in
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/exmem/MemtoReg_in
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/exmem/jal_in
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/exmem/bne_in
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/exmem/Regdst_in
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/exmem/jsel_in
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/exmem/aluop_in
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/exmem/rdat1_out
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/exmem/rdat2_out
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/exmem/npcout
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/exmem/newpcout
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/exmem/dWEN_out
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/exmem/dREN_out
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/exmem/RegWEN_out
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/exmem/MemtoReg_out
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/exmem/jal_out
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/exmem/bne_out
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/exmem/Regdst_out
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/exmem/jsel_out
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/exmem/aluop_out
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/exmem/outputPort_in
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/exmem/outputPort_out
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/exmem/zero_in
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/exmem/zero_out
...
WaveRestoreCursors {{Cursor 1} {1248418 ps} 0}
...
update
WaveRestoreZoom {1312215500 ps} {1313925500 ps}
