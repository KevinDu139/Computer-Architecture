...
add wave -noupdate -group rfif -radix hexadecimal /system_tb/DUT/CPU/DP/rfif/wdat
add wave -noupdate -group rfif -radix hexadecimal /system_tb/DUT/CPU/DP/rfif/rdat1
add wave -noupdate -group rfif -radix hexadecimal /system_tb/DUT/CPU/DP/rfif/rdat2
...
WaveRestoreCursors {{Cursor 1} {7059476 ps} 0}
...
update
WaveRestoreZoom {6556700 ps} {7614700 ps}
